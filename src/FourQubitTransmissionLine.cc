//
/// \file src/FourQubitTransmissionLine.cc
/// \brief Definition of FourQubitTransmissionLine class
///  
...
// Primary Constructor
FourQubitTransmissionLine::FourQubitTransmissionLine(G4RotationMatrix * pRot,
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
// Default Constructor
FourQubitTransmissionLine::FourQubitTransmissionLine()
{  
}
...
void FourQubitTransmissionLine::ConstructTransmissionLine(G4RotationMatrix * pRot,
							     const G4ThreeVector & tLate,
							     const G4String & pName,
							     G4LogicalVolume * pMotherLogical,
							     G4bool pMany,
...
G4UnionSolid * FourQubitTransmissionLine::CreatePieceBasedNbLayer(G4String nameSolid)
{
  //------------------------------------------------------------------------------------------
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
std::vector<std::tuple<std::string,G4String,G4VPhysicalVolume*> > FourQubitTransmissionLine::GetListOfAllFundamentalSubVolumes()
{
  return fFundamentalVolumeList;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void FourQubitTransmissionLine::AddComplexGeometryPadSubVolumesToThisList(FourQubitPad * pad)
{

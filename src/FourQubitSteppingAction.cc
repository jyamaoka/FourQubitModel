...
//Default constructor
FourQubitSteppingAction::FourQubitSteppingAction()
{
...
void FourQubitSteppingAction::UserSteppingAction( const G4Step * step )
{
...
void FourQubitSteppingAction::ExportStepInformation( const G4Step * step )
{
  //Test

//
/// \file FourQubitStraightFluxLine.hh
/// \brief Definition of the class defining Straight Flux
///  

#ifndef FourQubitStraightFluxLine_hh
#define FourQubitStraightFluxLine_hh 1
